...
<path d="M13.749 4.5L4.74902 13.5" stroke="#FF6363" stroke-width="1.56258" stroke-linecap="round" stroke-linejoin="round"/>
<path d="M4.74902 4.5L13.749 13.5" stroke="#FF6363" stroke-width="1.56258" stroke-linecap="round" stroke-linejoin="round"/>
</svg>
`,
                  }).click(function () {
        ...
        this.each(function () {
          if ('undefined' == typeof a(this).attr('data-tagsinput-init')) {
            ...
            if (
              (f.interactive &&
                (i =
                  i + '<input id="' + e + '_tag" value="" data-default="' + f.defaultText + '" />'),
              ...
              '' != a(h.real_input).val() &&
                a.fn.tagsInput.importTags(a(h.real_input), a(h.real_input).val()),
              f.interactive)
            ) {
              if (
                ...
                a(h.fake_input).bind('focus', h, function (b) {
                  a(b.data.fake_input).val() == a(b.data.fake_input).attr('data-default') &&
                    ...
                    a(b.data.fake_input).css('color', '#ffffff');
                }),
                ...
                void 0 !== jQuery.Autocompleter
                  ...
                  : void 0 !== jQuery.ui.autocomplete &&
                    ...
                    a(h.fake_input).bind('autocompleteselect', h, function (b, c) {
                      return (
                        a(b.data.real_input).addTag(c.item.value, { focus: !0, unique: f.unique }),
                        !1
                      );
                    }));
              } else
                a(h.fake_input).bind('blur', h, function (b) {
                  ...
                  return (
                    '' != a(b.data.fake_input).val() && a(b.data.fake_input).val() != c
                      ...
                      : (a(b.data.fake_input).val(a(b.data.fake_input).attr('data-default')),
                        a(b.data.fake_input).css('#3C4043', f.placeholderColor)),
                    !1
                  );
                });
              a(h.fake_input).bind('keypress', h, function (b) {
                ...
                h.unique &&
                  a(h.fake_input).keydown(function (b) {
                    (8 == b.keyCode ||
                      String.fromCharCode(b.which).match(/\w+|[áéíóúÁÉÍÓÚñÑ,/]+/)) &&
